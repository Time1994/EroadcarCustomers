...
public class CountyStoreAdapter extends BaseAdapter {
    private ArrayList<CountyStoreBean> mData;
    private Context mContext;
    private LayoutInflater infater = null;
    private Double latm = 31.21, lngm = 121.899;

    public CountyStoreAdapter(Context context, ArrayList<CountyStoreBean> data, double lat, double lon) {
    ...
    public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        CountyStoreBean bean = mData.get(position);
        ...
        ((MainActivity) mContext).setImage(Constant.HTTP + bean.getPmg_shop_head(), holder.store_iv,
                R.mipmap.ic_launcher);
        if (latm != null && lngm != null) {
            LatLng start = new LatLng(latm, lngm);
