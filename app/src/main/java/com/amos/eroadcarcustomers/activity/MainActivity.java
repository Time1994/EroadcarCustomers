...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        you_pop_ll = (LinearLayout) findViewById(R.id.you_pop_ll);
        you_iv = (ImageView) findViewById(R.id.you_iv);
        city_iv = (ImageView) findViewById(R.id.city_iv);
        datainfo_tv = (TextView) findViewById(R.id.datainfo_tv);
        you_tv = (TextView) findViewById(R.id.you_tv);
        juli_tv = (TextView) findViewById(R.id.juli_tv);
...
//        personalcenter_tv.setOnClickListener(this);
    ...
    private void getPoints() {
        loadingDialog.setMessage("正在获取门店信息...");
    ...
    private void getCountyByCity(String city) {
        loadingDialog.setMessage("正在获取城市信息...");
        loadingDialog.dialogShow();
            ...
            switch (msg.what) {
                ...
                case 2:
                    if (storeBean != null && storeBean.getData().size() != 0 && storeBean
                        ...
                        mainAdapter = new HomePageAdapter(MainActivity.this, storeBean.getData(),
                                latm, lngm);
                ...
                case 3:
                    if (cityBean != null && cityBean.getData().size() != 0 && cityBean.getState().equals("success")) {
                        cityAdapter = new CityAdapter(MainActivity.this, cityBean.getData());
                ...
                case 4:
                    if (countyStoreBean != null && countyStoreBean.getData().size() != 0 && countyStoreBean
                            .getState().equals("success")) {
                        countyStoreAdapter = new CountyStoreAdapter(MainActivity.this, countyStoreBean.getData(), latm, lngm);
